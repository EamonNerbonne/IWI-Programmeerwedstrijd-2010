...
class OutputSplitter:
    def __init__(self, max_file_size, path_name):
        self.__dir_index = 0
        self.__file_index = -1
...
def main():
    ...
    try:
        long_opts = ['help', 'usage', 'bytes=', 'output=', 'input=']
        opts, args = getopt.gnu_getopt(sys.argv[1:], 'b:o:i:', long_opts)
    ...
    output_splitter = OutputSplitter(file_size, output_dir)
    process_data(open(input_file, 'rt'), wiki_extractor, output_splitter)
